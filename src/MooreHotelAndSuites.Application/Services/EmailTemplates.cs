...
<head>
    ...
    <title>Confirm Your Account - Moore Hotel & Suites</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<body>
    <div class='container'>
        <div class='header'>
            ...
            <div class='tagline'>Luxury & Comfort Awaits</div>
        </div>
        <div class='content'>
            <div class='greeting'>Hello, {name}!</div>
            <div class='message'>
                Welcome to <strong>Moore Hotel & Suites</strong>! We're thrilled to have you join our family.
                <br><br>
        ...
        <div class='footer'>
            ...
            <p>Moore Hotel & Suites | Your Home Away From Home</p>
        </div>
    </div>
</body>
</html>";
